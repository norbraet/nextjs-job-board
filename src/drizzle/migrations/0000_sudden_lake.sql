...
CREATE TYPE "public"."job_listings_job_listings_status" AS ENUM('draft', 'published', 'delisted');--> statement-breakpoint
CREATE TYPE "public"."job_listings_job_listing_type" AS ENUM('draft', 'published', 'delisted');--> statement-breakpoint
...
CREATE TABLE "job_listings" (
	...
	"status" "job_listings_job_listings_status" DEFAULT 'draft' NOT NULL,
	"type" "job_listings_job_listing_type" NOT NULL,
